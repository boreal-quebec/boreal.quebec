...
export default function NavFooterBanners(){
    ...
    const style = {
        ...
        titleFont: "text-4xl sm:text-5xl xl:text-3xl 2xl:text-4xl font-bold tracking-widest",
        textFont: "text-xl 2xl:text-2xl font-medium"
    }

    return(
        <div className={"flex flex-col xl:flex-row xl:h-screen"}>
            <div className={`flex flex-col justify-between bg-beige ${style.collumnPadding} xl:w-1/4`}>
            ...
            <div className={`flex flex-col justify-between bg-secondary ${style.collumnPadding} xl:w-1/4`}>
            ...
            <div className={`flex flex-col justify-between bg-primary ${style.collumnPadding} xl:w-1/4`}>
            ...
            <div className={`flex flex-col justify-between bg-secondary-800 ${style.collumnPadding} xl:w-1/4`}>
