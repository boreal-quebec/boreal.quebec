...
interface HomePageCollumnsSmProps {

};

const HomePageColumnsSm = ({}: HomePageCollumnsSmProps) => {
    let {openLaunchModal, closeLaunchModal} = useContext(LaunchContext);

    return (
        <div className={"md:hidden flex flex-col xl:flex-row xl:h-[750px]"}>
            <div className={`flex flex-col justify-between bg-beige xl:w-1/4`}>
                <HomePageColumnSection>
                    <div className={"flex justify-between"}>
                        ...
                        <Image className={"w-[49px] h-[51px]"} src={Loupe} alt={"loupe"} />
                    </div>
            ...
            <div className={`flex flex-col justify-between bg-secondary xl:w-1/4`}>
                <HomePageColumnSection>
                    <div className={"flex justify-between"}>
                        ...
                        <Image className={"w-[49px] h-[51px]"} src={Stairs} alt={"loupe"} />
                    </div>
            ...
            <div className={`flex flex-col justify-between bg-primary xl:w-1/4`}>
                <HomePageColumnSection>
                    <div className={"flex justify-between"}>
                        ...
                        <Image className={"w-[49px] h-[51px]"} src={Hero} alt={"loupe"} />
                    </div>
            ...
            <div className={`flex flex-col justify-between bg-secondary-800 xl:w-1/4`}>
                <HomePageColumnSection>
                    <div className={"flex justify-between"}>
                        ...
                        <Image className={"w-[49px] h-[51px]"} src={Star} alt={"loupe"} />
                    </div>
...
export default HomePageColumnsSm;